...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/VERSION-v1.8.1_STABLE-00D68F?style=for-the-badge" alt="Version">
...
5. **View Your Gallery:** Once saved, your photo instantly appears on your Dashboard under "Recent Masterpiece". You can click it to view it in full size or download it to your device.
...
| Version | Notes |
|---|---|
| **v1.8.1** | **STABLE** — Cloud-only gallery sync, grid view, and image distortion fix |
| **v1.7.3** | Removed LocalStorage for prints; Aiven PostgreSQL is now the source of truth |
| **v1.6.1** | AI Face Tracking, Smart Bokeh, High-Res Cinema Layouts, and 10+ Themed Studio Frames |
